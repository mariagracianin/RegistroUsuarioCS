...
public class EmpActividadesController implements Initializable {
    ...
    private List<SuperActividadDTO> getDatos(){
        ...
        HorarioConCuposDTO h1 = new HorarioConCuposDTO(3,13,14);
        HorarioConCuposDTO h2 = new HorarioConCuposDTO(4,13,14);
        HorarioConCuposDTO h3 = new HorarioConCuposDTO(3,13,14);
